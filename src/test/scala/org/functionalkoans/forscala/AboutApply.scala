...
class AboutApply extends KoanSuite {
    koan(
        """The apply method is a magical method in Scala, it is a method that doesn't require you
    ...
    koan(
        """The apply method can also be used in singleton objects as well, in fact, it is the most common way
